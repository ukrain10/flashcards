...
let AttributeModule = exports.AttributeModule = class AttributeModule {
};
exports.AttributeModule = AttributeModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'Attribute', schema: attribute_model_1.AttributeSchema }]),
        ],
